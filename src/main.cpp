...
int main() {
  ...
  //  Shader lightshowShader("resources/shaders/lightshow.vs", "resources/shaders/lightshow.fs");
    ...
    Model ourModel("resources/objects/brod/ShipV_LOW.obj");
    ...
    vector<std::string> faces
            {
                    FileSystem::getPath("resources/textures/moj_skybox/cave3_rt.png"),
                    FileSystem::getPath("resources/textures/moj_skybox/cave3_lf.png"),
                    FileSystem::getPath("resources/textures/moj_skybox/cave3_up.png"),
                    FileSystem::getPath("resources/textures/moj_skybox/cave3_dn.png"),
                    FileSystem::getPath("resources/textures/moj_skybox/cave3_bk.png"),
                    FileSystem::getPath("resources/textures/moj_skybox/cave3_ft.png")
            };
